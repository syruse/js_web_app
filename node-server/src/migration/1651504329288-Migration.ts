...
export class Migration1651504329288 implements MigrationInterface {
    name = 'Migration1651504329288'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`phones\` (\`id\` int NOT NULL AUTO_INCREMENT, \`model\` varchar(255) NOT NULL, \`price\` decimal(5,2) NOT NULL, \`desc\` text NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`pass\` varchar(255) NOT NULL, \`date\` date NULL, \`cartId\` int NULL, UNIQUE INDEX \`REL_89502c44bd22c06e714c31c1e9\` (\`cartId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
