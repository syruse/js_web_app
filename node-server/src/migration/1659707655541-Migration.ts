...
export class Migration1659707655541 implements MigrationInterface {
    name = 'Migration1659707655541'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`purchases_users_users\` (\`purchasesId\` int NOT NULL, \`usersId\` int NOT NULL, INDEX \`IDX_ad84f3ef6cb79fac70290f0460\` (\`purchasesId\`), INDEX \`IDX_af4ea1998abaa91830b96e3b2b\` (\`usersId\`), PRIMARY KEY (\`purchasesId\`, \`usersId\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`purchases_users_users\` ADD CONSTRAINT \`FK_ad84f3ef6cb79fac70290f04600\` FOREIGN KEY (\`purchasesId\`) REFERENCES \`purchases\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`purchases_users_users\` ADD CONSTRAINT \`FK_af4ea1998abaa91830b96e3b2b6\` FOREIGN KEY (\`usersId\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`purchases_users_users\` DROP FOREIGN KEY \`FK_af4ea1998abaa91830b96e3b2b6\``);
        await queryRunner.query(`ALTER TABLE \`purchases_users_users\` DROP FOREIGN KEY \`FK_ad84f3ef6cb79fac70290f04600\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_af4ea1998abaa91830b96e3b2b\` ON \`purchases_users_users\``);
        await queryRunner.query(`DROP INDEX \`IDX_ad84f3ef6cb79fac70290f0460\` ON \`purchases_users_users\``);
        await queryRunner.query(`DROP TABLE \`purchases_users_users\``);
